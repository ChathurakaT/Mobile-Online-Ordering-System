            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <b><img src="images/logo.png" alt="homepage" class="dark-logo" height="50px" width="100px"/></b>
                    </a>
                </div>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-9 align-self-center">
                    <h1 class="text-primary">Online Mobile Shop System</h1> <h3 class="text-primary">Dashboard</h3> </div>
                    ...
                    <div class="col-md-3">
					 ...
					 <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-home f-s-50" aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
