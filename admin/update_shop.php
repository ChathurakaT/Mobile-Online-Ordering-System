                    ...
                    <ul id="sidebarnav">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-home f-s-20 color-warning"></i><span class="hide-menu">Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add_product.php">Add List</a></li>
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Mobile Shops</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" value="<?php echo $row['title'];  ?>" class="form-control" placeholder="Mobile Shop">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="email" value="<?php echo $row['email'];  ?>"class="form-control form-control-danger" placeholder="Anusha@gmail.com">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="077-555-5555">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
